...
// this is the thank you receipt when you return from a stripe payment from supporting a project
...
$meta = ID_Member_Order::get_order_meta($last_order->id, 'gateway_info', true);
...
<div class="ignitiondeck idc_lightbox idc-social-sharing-box idc_lightbox_attach mfp-hide">
    ...
    <div class="idc-order-info">
       ...
       <div class="order-details-grid">
            <table width="100%" border="0" class="table">
                ...
                <tbody>
                <tr class="details">
                    <td class="title"><?php echo apply_filters('idc_order_level_title', (isset($order_level_key) ? $levels[$order_level_key]->level_name : ''), $last_order); ?><!--<span class="authorname">By Author</span>--></td>
                    <td></td>
    ...
    <div class="social-sharing-options-wrapper">
        ...
        <div class="friendlink">
            ...
            <?php } ?>
            <div class="text"><?php _e('I just supported', 'memberdeck'); ?> <?php echo apply_filters('idc_order_level_title', (isset($order_level_key) ? $levels[$order_level_key]->level_name : ''), $last_order); ?> on GradLift.<br />
